...
const Kho = () =>{
  ...
  async function loadKho(){
    return await axios
      .get('http://192.168.123.17:3002/kho')
      .then((res) => {
        const result = {
  ...
  async function GetKhoEdit(MaKho){
    setEditMode(true)
    return await axios
      .get(`http://192.168.123.17:3002/Kho/${MaKho}`)
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
  ...
  async function CreateKho(values){
    ...
    return await axios
      .post('http://192.168.123.17:3002/Kho/create', {MaKho: values.MaKho, TenKho: values.TenKho, DiaChiKho: values.DiaChiKho})
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
  ...
  async function UpdateKho(values){
    ...
    return await axios
      .post(`http://192.168.123.17:3002/Kho/${dataEdit?.MaKho}`, {MaKho: values.MaKho, TenKho: values.TenKho, DiaChiKho: values.DiaChiKho})
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
  ...
  async function DeleteKho(MaKho){
    return await axios
      .post(`http://192.168.123.17:3002/Kho/delete/${MaKho}`)
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
