...
useEffect(()=>{
  ...
  async function loadKichThuoc(){
    return await axios
      .get('http://192.168.123.17:3002/KichThuoc')
      .then((res) => {
        const result = {
  ...
  async function GetKichThuocEdit(MaKichThuoc){
    ...
    setEditMode(true)
    return await axios
      .get(`http://192.168.123.17:3002/KichThuoc/${MaKichThuoc}`)
      .then((res) => {
        const result = {
          status: res.status,
  ...
  async function CreateKichThuoc(values){
    ...
    return await axios
      .post('http://192.168.123.17:3002/KichThuoc/create', {MaKichThuoc: values.MaKichThuoc,TenKichThuoc: values.TenKichThuoc})
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
  ...
  async function UpdateKichThuoc(values){
    ...
    return await axios
      .post(`http://192.168.123.17:3002/KichThuoc/${dataEdit?.id}`, {MaKichThuoc: values.MaKichThuoc, TenKichThuoc: values.TenKichThuoc})
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
  ...
  async function DeleteKichThuoc(MaKichThuoc){
    return await axios
      .post(`http://192.168.123.17:3002/KichThuoc/delete/${MaKichThuoc}`)
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
