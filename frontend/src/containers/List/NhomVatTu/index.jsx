...
const NhomVatTu = () =>{
  ...
  async function loadNhomVatTu(){
    return await axios
      .get('http://192.168.123.17:3002/NhomVatTu')
      .then((res) => {
        const result = {
  ...
  async function GetNhomVatTuEdit(MaNhomVatTu){
    setEditMode(true)
    return await axios
      .get(`http://192.168.123.17:3002/NhomVatTu/${MaNhomVatTu}`)
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
  ...
  async function CreateNhomVatTu(values){
    ...
    return await axios
      .post('http://192.168.123.17:3002/NhomVatTu/create', {MaNhomVatTu: values.MaNhomVatTu,TenNhomVatTu: values.TenNhomVatTu, DiaChiNhomVatTu: values.DiaChiNhomVatTu})
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
  ...
  async function UpdateNhomVatTu(values){
    ...
    return await axios
      .post(`http://192.168.123.17:3002/NhomVatTu/${dataEdit?.MaNhomVatTu}`, {MaNhomVatTu: values.MaNhomVatTu, TenNhomVatTu: values.TenNhomVatTu, DiaChiNhomVatTu: values.DiaChiNhomVatTu})
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
  ...
  async function DeleteNhomVatTu(MaNhomVatTu){
    return await axios
      .post(`http://192.168.123.17:3002/NhomVatTu/delete/${MaNhomVatTu}`)
      .then((res) => {
        const result = {
          status: res.status,
          data: res.data.result.recordset,
